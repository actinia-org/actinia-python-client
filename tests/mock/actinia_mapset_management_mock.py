...
mapset_creation_resp = {
    ...
    "api_info": {
        ...
        "method": "POST",
        "path": f"/api/{ACTINIA_VERSION}/locations/test_location/mapsets/test_mapset",
...
delete_mapset_resp = {
    "response": {
        ...
        "api_info": {
            ...
            "method": "DELETE",
            "path": f"/api/{ACTINIA_VERSION}/locations/test_location/mapsets/test_mapset",
            "request_url": f"{ACTINIA_BASEURL}/api/{ACTINIA_VERSION}/locations/test_location/mapsets/test_mapset"
        },
        ...
        "urls": {
            "resources": [],
            "status": f"{ACTINIA_BASEURL}/api/{ACTINIA_VERSION}/resources/testuser/resource_id-af7aa2aa-5db0-4e8b-b921-05a7b99ac0c5"
        },
        "user_id": "testuser"
    }
}
...
get_mapsets_resp = {
    "response": {
        ...
        "api_info": {
            ...
            "request_url": f"{ACTINIA_BASEURL}/api/{ACTINIA_VERSION}/locations/test_location/mapsets"
        }, 
        ...
        "process_chain_list": [
            ...
            "urls": {
                "resources": [],
                "status": f"{ACTINIA_BASEURL}/api/{ACTINIA_VERSION}/resources/testuser/resource_id-ba4de6ee-733c-4c29-887d-2d6c14dbd17c"
            },
            "user_id": "testuser"
        }
    }
...
mapset_get_info_resp = {
    ...
    "api_info": {
        ...
        "method": "GET",
        "path": f"/api/{ACTINIA_VERSION}/locations/test_location/mapsets/test_mapset/info/",
        "request_url": f"{ACTINIA_BASEURL}/api/{ACTINIA_VERSION}/locations/test_location/mapsets/test_mapset/info/"
    },
    ...
    "urls": {
        "resources": [],
        "status": f"{ACTINIA_BASEURL}/api/{ACTINIA_VERSION}/resources/testuser/resource_id-a5b61779-ee68-426b-b3ed-991aaf24b980"
    },
    "user_id": "testuser"
}
